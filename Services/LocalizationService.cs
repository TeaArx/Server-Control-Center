...
public sealed class LocalizationService : INotifyPropertyChanged
{
    private readonly Dictionary<string, Dictionary<string, string>> resources = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["TerminalConnectingTo"] = "Opening an interactive session with {0}...",
            ["TerminalDisconnected"] = "Interactive session is not connected",
            ["TerminalInteractiveReady"] = "Interactive session · live output",
            ["TerminalInputHint"] = "Enter a command or a response requested by the server (for example, y/n).",
            ["TerminalInputPlaceholder"] = "Command or response to the server",
            ["TerminalInputSent"] = "Terminal input sent",
            ["TerminalOutputTrimmed"] = "— Earlier terminal output was trimmed —",
            ["Interrupt"] = "Interrupt",
            ["InterruptTerminalShortcut"] = "Interrupt current process (Ctrl+C)",
            ["DisconnectTerminal"] = "Disconnect SSH session",
            ["TerminalDisconnectedMessage"] = "SSH session disconnected.",
            ["OpenSystemTerminal"] = "Open in Windows Terminal",
            ["SystemTerminalOpened"] = "System terminal opened",
            ["SystemTerminalError"] = "Could not open system terminal: {0}",
            ...
            ["SavedCommandsHint"] = "Select a command to view, edit, favorite, or run it.",
            ["ServerProfileSummary"] = "SERVER PROFILE",
            ["ConnectionAddress"] = "Connection",
            ["OperatingSystem"] = "Operating system",
            ["ResourceUsage"] = "Resource usage",
            ["CpuUsage"] = "Processor (CPU)",
            ["DiskUsageRoot"] = "Root disk (/)",
            ["SystemLoad"] = "System load",
            ["SystemLoadHint"] = "1-minute load average relative to the number of CPU cores.",
            ["NetworkTraffic"] = "Current network traffic",
            ["TopProcesses"] = "Top processes by CPU",
            ["TopProcessesHint"] = "PID, process name, CPU and memory usage. Higher rows use more CPU.",
            ["SystemInformation"] = "System details",
            ["StorageDetails"] = "Root filesystem",
            ["NetworkInterfaces"] = "Active network interfaces",
        ...
        ["ru"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["TerminalConnectingTo"] = "Открывается интерактивная сессия с {0}...",
            ["TerminalDisconnected"] = "Интерактивная сессия не подключена",
            ["TerminalInteractiveReady"] = "Интерактивная сессия · вывод в реальном времени",
            ["TerminalInputHint"] = "Введите команду или ответ, который запросил сервер (например, y/n).",
            ["TerminalInputPlaceholder"] = "Команда или ответ серверу",
            ["TerminalInputSent"] = "Ввод отправлен в терминал",
            ["TerminalOutputTrimmed"] = "— Более ранний вывод терминала скрыт —",
            ["Interrupt"] = "Прервать",
            ["InterruptTerminalShortcut"] = "Прервать текущий процесс (Ctrl+C)",
            ["DisconnectTerminal"] = "Отключить SSH-сессию",
            ["TerminalDisconnectedMessage"] = "SSH-сессия отключена.",
            ["OpenSystemTerminal"] = "Открыть в терминале Windows",
            ["SystemTerminalOpened"] = "Системный терминал открыт",
            ["SystemTerminalError"] = "Не удалось открыть системный терминал: {0}",
            ...
            ["SavedCommands"] = "Сохранённые команды",
            ["SavedCommandsHint"] = "Выберите команду, чтобы посмотреть, изменить, добавить в избранное или запустить её.",
            ["ServerProfileSummary"] = "ПРОФИЛЬ СЕРВЕРА",
            ["ConnectionAddress"] = "Подключение",
            ["OperatingSystem"] = "Операционная система",
            ["ResourceUsage"] = "Использование ресурсов",
            ["CpuUsage"] = "Процессор (CPU)",
            ["DiskUsageRoot"] = "Корневой диск (/)",
            ["SystemLoad"] = "Нагрузка системы",
            ["SystemLoadHint"] = "Средняя нагрузка за 1 минуту относительно количества ядер CPU.",
            ["NetworkTraffic"] = "Текущий сетевой трафик",
            ["TopProcesses"] = "Процессы с наибольшей нагрузкой CPU",
            ["TopProcessesHint"] = "PID, имя процесса, нагрузка CPU и расход памяти. Чем выше строка, тем больше нагрузка.",
            ["SystemInformation"] = "Сведения о системе",
            ["StorageDetails"] = "Корневая файловая система",
            ["NetworkInterfaces"] = "Активные сетевые интерфейсы",
